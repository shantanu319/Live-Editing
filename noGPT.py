import os
import openai
# openai.organization = "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"
...
class SpellChecker:
    ...
    # def chat_bot(prompt, model="gpt-3.5-turbo"):
    #  response = openai.Completion.create(engine=model, prompt=prompt, max_tokens=100, n=1, stop=None,
    # temperature=0.5, )
    #  correctedWord = response.choices[0].text.strip()
